        ...
        <div className="hidden md:flex grow items-center">
          <div className="hidden md:flex create-btn items-center mx-8 px-4 element-with-gradient h-8">
            ...
            <div className="relative grow">
              ...
              <input type="search" className="element-with-gradient block w-full p-4 ps-16 text-sm rounded-full bg-black searchbox" placeholder="Explore" />
            </div>
